...
const Contact = () => {
    return (
        <div
            id="effect"
            className="flex flex-col justify-center items-center w-full h-auto   px-4 py-4 "
        >
            <div className=" h-full sm:w-[100%] w-[90%] pt-10   flex flex-col justify-start items-center gap-10 px-[1%] ">

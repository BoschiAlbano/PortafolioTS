import { info } from "../model/menu";

export const contacto: info[] = [
  {
    icon: (
      <svg
        stroke="currentColor"
        ...
        className=" w-full h-full fill-[#c2cf09]"
      >
    ...
    title: "EMAIL",
    text: "boschi.albano.jose@gmail.com",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    title: "UBICACION",
    text: "Argentina - Tucuman - San Miguel de Tucuman",
  },
];
